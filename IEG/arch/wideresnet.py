...
class WideResNet(nn.Module):
    def __init__(self, num_classes, depth=28, widen_factor=2, drop_rate=0.0, with_fc=True):
...
def wideresnet(depth=28, widen_factor=2, dropout=0, num_classes=10, with_fc=True):
